...
<template>
        ...
        <h1 class="text-5xl text-center lg:mb-28 mb-0 ">My experience</h1>
    <article class="grid lg:grid-cols-2 grid-cols-1 justify-center items-center lg:mb-20 mb-10 gap-10">
        ...
        <div class="flex flex-col gap-10 justify-center lg:ml-10 ml-0 lg:text-left text-center">
            ...
            <a href="https://pesi.pl/" class="bg-based text-secondary hover:bg-opacity-30 hover:text-text duration-300 px-4 py-2 rounded w-fit font-semibold lg:mx-0 mx-auto " target="_blank">
                Visit Website
            </a>
        </div>
    </article>
    ...
    <article class="grid  lg:grid-cols-2 grid-cols-1   justify-center items-center ">
        <div class="flex flex-col gap-10 justify-center text-center lg:text-left lg:mb-0 mb-10">
            <h2 class="lg:text-[38px] text-[28px]  font-semibold text-balance " style="animation-delay: 0s;">Energoobsługa</h2>
    ...
    <article class="grid  lg:grid-cols-2 grid-cols-1   justify-center items-center ">
        <div class="flex flex-col gap-10 justify-center text-center lg:text-left lg:mb-0 mb-10">
            <h2 class="lg:text-[38px] text-[28px]  font-semibold text-balance " style="animation-delay: 0s;">Wczesnoszkolni</h2>
            <ul class="text-xl leading-10 w-fit list-disc ">
                <li>I gained significant back-end development experience.</li>
    ...
    <article class="grid  lg:grid-cols-2 grid-cols-1 t   justify-center items-center ">
        <div class="flex flex-col gap-10 justify-center text-center lg:text-left lg:mb-0 mb-10 order-last">
            <h2 class="text-[36px] text-balance mt-20" style="animation-delay: 0s; color: #D8A25E;">Wedding Photography</h2>
            <p class="text-xl leading-10 w-fit">
            ...
            <a href="/work" class="bg-based text-secondary hover:bg-opacity-30 hover:text-text duration-300 px-4 py-2 rounded w-fit font-semibold" target="_blank">
                See My Work
            </a>
        </div>
